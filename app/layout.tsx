...
export const metadata: Metadata = {
    ...
    title: {
        default: 'Купить кардиограф СмартКардио® | Беспроводной ЭКГ прибор для дома',
        template: '%s | СмартКардио® - Беспроводной кардиограф',
    },
    description:
        'Купить беспроводной кардиограф СмартКардио® с доставкой по России. ЭКГ и измерение сатурации без геля и проводов. Результат сразу в телефоне. Российское производство. Гарантия качества.',
    keywords: [
