...
const reviews = [
  ...
  { author: "Павел С.", date: "2025-01-25", rating: 5, text: "Использую для ежедневного мониторинга. Данные за несколько месяцев видны в истории — удобно отслеживать динамику и показывать врачу сразу архив, а не один снимок. Функция сатурации тоже пригоди��ась." },
